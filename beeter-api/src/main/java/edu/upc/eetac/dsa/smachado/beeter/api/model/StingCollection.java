...
public class StingCollection {
	...
	//Constructor que crea un objeto de tipo List
	public StingCollection() {
		super();
		stings = new ArrayList<>();
	}
	
	//Metodo que devuelve la lista de stings
	public List<Sting> getStings() {
		return stings;
	}
	
	//Metodo que añade una lista de Stings
	public void setStings(List<Sting> stings) {
		this.stings = stings;
	}
 
	//Metodo que añade UN STING A UNA LISTA DE STINGS
